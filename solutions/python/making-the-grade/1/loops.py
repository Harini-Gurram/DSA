...
def letter_grades(highest):
    ...
    Returns:
        ...
        The result would be [41, 56, 71, 86]:
            ...
            86 <= "A" <= 100
    """
    step_value=round((highest-41)/4)
    grades=[41]
    for i in range(41,highest-step_value,step_value):
        grades.append(grades[-1]+step_value)
    return grades
...
def student_ranking(student_scores, student_names):
    ...
    for index,value in enumerate(student_scores):
        rank_string=str(index+1)+". "+student_names[index]+": "+str(value)
